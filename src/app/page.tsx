...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      { text: '8–12 high-conviction positional setups/month', ok: true },
      { text: 'Entry zone, 2 targets, stop-loss on every pick', ok: true },
      { text: 'Written research rationale on every pick', ok: true },
      ...
      { text: 'Access to full research archive', ok: true },
    ],
  ...
  },
  {
    ...
    features: [
      { text: 'Everything in Positional', ok: true },
      { text: 'Your choice: Intraday · Stock Options · Index Options', ok: true },
      { text: 'WhatsApp research delivery before 9 AM', ok: true },
      { text: '3 institutional research reports/month', ok: true },
      { text: '1 × 15-min strategy session with Sahib/month', ok: true },
  ...
  },
  {
    ...
    features: [
      { text: 'Everything in Pro — all 3 services included', ok: true },
      { text: '4 × 15-min weekly strategy calls with Sahib', ok: true },
      { text: 'Monthly portfolio review + trade feedback', ok: true },
      { text: 'Bespoke research note — exclusively for you', ok: true },
      { text: 'Direct call + WhatsApp access to Sahib', ok: true },
      { text: '🎁 Market Foundations course (₹24,999 value)', ok: true },
    ],
    cta: 'Go Elite',
    color: 'gold',
  },
