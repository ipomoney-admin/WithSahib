...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'NSE Stock Options Research',
  description: 'Weekly and monthly stock options research by SEBI RA Sahib Singh Hora (INH000026266). Strike selection, premium targets, and risk-defined setups for NSE F&O eligible stocks.',
  provider: {
    '@type': 'Person',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Stock Options', item: 'https://www.withsahib.com/services/stock-options' },
  ],
}
