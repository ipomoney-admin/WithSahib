...
const SERVICES_DETAIL = [
  ...
  },
  {
    ...
    badge: '8–12/Month · Positional Plan',
    badgeColor: '#64A0FF',
    desc: 'High-conviction positional research for 2–10 day NSE equity setups. Based on chart pattern breakouts — flags, triangles, cup-and-handle — combined with volume confirmation and multi-timeframe analysis. Every pick includes full written rationale.',
    features: [
      '8–12 high-conviction setups per month',
      ...
      'Weekly research digest with closed-trade summary',
    ],
    why: 'Positional research suits working professionals who cannot watch screens all day. All picks are for NSE-listed stocks with good liquidity and clear technical setups.',
    href: '/pricing',
    cta: 'Start with Positional Plan →',
  },
  {
    id: 'portfolio',
    ...
    badge: 'Quarterly · Positional Plan',
    badgeColor: '#64A0FF',
