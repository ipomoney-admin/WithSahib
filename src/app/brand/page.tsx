          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
            ...
            <div>
              ...
              <svg width="510" height="300" viewBox="0 0 510 300" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', borderRadius: 8 }}>
                ...
                {/* Service tags */}
                {['Intraday Picks', 'Nifty Options', 'Bank Nifty', 'Swing Trades', 'Model Portfolio', 'Research Reports'].map((svc, i) => {
                  const cols = 3
                  const col = i % cols
        ...
        <section style={{ marginBottom: 72 }}>
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <svg width="100%" viewBox="0 0 1500 500" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: 8 }}>
              ...
              {/* Subline */}
              <text x="80" y="318" fill="#8FA8C0" fontFamily="system-ui" fontSize="20" fontWeight="300">SEBI Registered Research Analyst · Intraday Picks · Options · Swing Trades · Research Reports</text>
              {/* SEBI badge */}
          ...
          <div style={{ marginBottom: 40 }}>
            ...
            <svg width="100%" viewBox="0 0 1584 396" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: 8 }}>
              ...
              {/* Services line */}
              <text x="60" y="330" fill="#4A6580" fontFamily="system-ui" fontSize="14">Intraday Picks  ·  Nifty Options  ·  Bank Nifty  ·  Swing Trades  ·  Research Reports</text>
              {/* Right */}
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <svg width="100%" viewBox="0 0 851 315" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: 8 }}>
              ...
              <text x="50" y="268" fill="#4A6580" fontFamily="system-ui" fontSize="12">Intraday Picks · Options Signals · Swing Trades · Research Reports · 1-on-1 Advisory</text>
