    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh' }}>
      ...
      <section style={{ padding: '64px 40px 56px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        <div style={{ maxWidth: 680, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div className="section-tag" style={{ justifyContent: 'center', marginBottom: 20 }}>{t('courses.eyebrow')}</div>
          <h1 style={{
            ...
            {t('courses.headline1')}{' '}
            <em style={{ color: 'var(--orange)', fontStyle: 'italic', fontWeight: 400 }}>{t('courses.headline2')}</em>
          </h1>
          ...
          {COURSES.map((course) => (
            ...
            >
              ...
              <p style={{ fontSize: 13, color: 'var(--text3)', marginBottom: 20, paddingBottom: 20, borderBottom: '1px solid var(--border)', fontFamily: 'var(--font-body)', lineHeight: 1.5 }}>
                One-time · {t('courses.handholding')}
              </p>
