...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Which to trade? (1) Directional bets with big moves — Bank Nifty tips are better, volatility is higher. (2) Premium selling / theta decay strategies — Nifty options are calmer and more predictable. (3) Hedging your equity portfolio — Nifty puts are the standard tool.',
      'withSahib\'s options advisory covers both: Nifty options tips today (published pre-expiry) and Bank Nifty calls using OI analysis, PCR signals, and volatility percentile. Every options call from Sahib Singh Hora (INH000026266) includes the strike, premium range, target, stop-loss, and the full rationale.',
  ...
  },
  {
    ...
    body: [
      ...
      'Step 2: Navigate to Registered Intermediaries. On the SEBI homepage, click "Registered Intermediaries" or navigate directly to the Research Analyst search page at sebi.gov.in/sebiweb/other/OtherAction.do?doRecognisedFpi=yes&intmId=13',
