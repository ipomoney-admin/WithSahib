...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    tags: ['Intraday Trading', 'NSE Calls', 'Stop Loss', 'Risk Management'],
    body: [
      ...
      'The Target Price is where you exit with profit. For NSE intraday calls, targets are typically 0.5% to 2.5% from entry depending on the stock\'s Average True Range (ATR). Multiple targets allow partial profit-booking. Target 1 is conservative; Target 2 is if momentum continues.',
      ...
      'All withSahib intraday calls follow this framework — entry, target, SL, and the technical rationale behind the trade. No guesswork. No anonymous signals. Just SEBI-compliant research from a verified analyst.',
    ],
  },
  {
  ...
  },
  {
    ...
    tags: ['intraday calls', 'intraday calls NSE', 'market intelligence today', 'best stock to buy today'],
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      'Research Analyst vs Investment Adviser: A Research Analyst (RA) publishes general research reports accessible to all clients — like Sahib Singh Hora\'s intraday calls on withSahib.com. An Investment Adviser (IA) provides personalised advice based on a client\'s specific financial situation, goals, and risk profile. The withSahib platform provides general research, not personalised investment advice.',
  ...
  },
  {
    ...
    tags: ['swing trading stocks', 'best stocks to buy', 'NSE calls', 'positional trading India'],
    body: [
