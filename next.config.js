      ...
      // Security headers on all routes
      {
        ...
        headers: [
          ...
          { key: 'Cross-Origin-Opener-Policy', value: 'same-origin-allow-popups' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.clarity.ms https://checkout.razorpay.com",
              "style-src 'self' 'unsafe-inline'",
              "font-src 'self'",
              "img-src 'self' data: https: blob:",
              "connect-src 'self' https://*.supabase.co https://*.clarity.ms https://ipapi.co https://api.razorpay.com https://checkout.razorpay.com",
